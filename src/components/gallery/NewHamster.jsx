					...
					? <>
						...
						<div className="form">
							<label>Name:
								<input
									type="text"
									onChange={event => { setHamster("name", event.target.value); }}
							...
							<label>Age:
								<input
									type="text"
									onChange={event => { setHamster("age", event.target.value); }}
						...
						{!allValid ?
							<p className="correct">Please fill out all the fields correctly!</p>
							:
